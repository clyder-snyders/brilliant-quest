  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8" style={{ background: 'linear-gradient(180deg, #F0F5FF 0%, #F7F9FC 100%)' }}>
      <button
        ...
        className="absolute top-4 left-4 p-2 rounded-lg hover:bg-blue-100 transition-colors"
      ...
      <div className="max-w-2xl w-full game-card">
        <h1 className="text-4xl font-bold mb-6 text-center" style={{ color: 'hsl(217, 33%, 17%)' }}>
          About Brilliant Quest
        </h1>

        <div className="space-y-6" style={{ color: 'hsl(215, 16%, 47%)' }}>
          <section>
            <h2 className="text-2xl font-bold mb-2" style={{ color: 'hsl(217, 33%, 17%)' }}>
              What is Brilliant Quest?
            </h2>
            <p className="text-base leading-relaxed">
              Brilliant Quest is an interactive educational game designed to teach programming concepts through engaging puzzle challenges. Perfect for students aged 8-18 and anyone interested in learning to code!
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2">
              <li>✅ <strong>Completely Free</strong> - No ads, no charges, ever</li>
              <li>✅ <strong>Offline Support</strong> - Play without internet connection</li>
              <li>✅ <strong>Fully Responsive</strong> - Works on all devices</li>
              <li>✅ <strong>Save Progress</strong> - Your progress is saved automatically</li>
              <li>✅ <strong>Educational</strong> - Real coding concepts</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              Brilliant Quest is perfect for classrooms, coding clubs, and independent learning. Use it to teach fundamental programming concepts in an engaging, game-based format.
            </p>
          ...
          <section>
            ...
            <p className="text-sm">
              Brilliant Quest respects your privacy. We don't track personal data or show ads. Your game progress is saved locally on your device using browser storage.
            </p>
          </section>

          <section style={{ background: 'hsl(220, 33%, 95%)', padding: '1rem', borderRadius: '0.875rem' }}>
            <p className="text-center text-sm" style={{ color: 'hsl(217, 33%, 17%)' }}>
