...
import { deleteProfile } from '../game/storage';
...
export default function SetupScreen() {
  ...
  const handleBack = () => {
    dispatch({ type: 'SET_SCREEN', screen: profileExists ? 'levelMap' : 'welcome' });
  };
      ...
      <div className="game-card w-full max-w-[480px]">
        <div className="flex items-center mb-6">
          ...
          <div className="flex-1 text-center">
            ...
            <p className="text-sm mt-1" style={{ color: 'hsl(215, 16%, 47%)' }}>Personalize your experience</p>
          </div>
          <div className="w-8" />
        </div>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            style={{ border: error ? '2px solid hsl(0, 84%, 60%)' : '2px solid hsl(214, 32%, 91%)', background: 'white', fontFamily: 'Inter, sans-serif' }}
          ...
          <div className="grid grid-cols-3 gap-3">
            {avatarIds.map(id => (
              <button key={id} onClick={() => setAvatar(id)}
                ...
                style={{ border: avatar === id ? '2px solid hsl(217, 91%, 60%)' : '2px solid transparent', background: avatar === id ? 'hsl(217, 91%, 97%)' : 'hsl(220, 33%, 95%)' }}>
        ...
        <div className="rounded-[14px] p-4 mb-6" style={{ background: 'hsl(220, 33%, 95%)' }}>
          ...
          <div className="text-sm space-y-1" style={{ color: 'hsl(215, 16%, 47%)' }}>
            ...
            <p>• Unlock harder levels as you progress</p>
          </div>
        </div>
          ...
          <div className="fixed inset-0 flex items-center justify-center p-4 bg-black/40 z-50">
            <div className="game-card w-full max-w-[320px]">
              ...
              <p className="text-sm mb-4" style={{ color: 'hsl(215, 16%, 47%)' }}>
                This will permanently erase "{state.playerName}", your progress, and all game data.
              </p>
              <div className="grid grid-cols-2 gap-2">
                <button onClick={() => setShowConfirm(false)} className="btn-secondary py-2.5 text-sm">Cancel</button>
